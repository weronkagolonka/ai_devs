...
export class FileService {
    ...
    private metadataDirectory: string = "./metadata";
        ...
        if (metadataFromFile) {
            ...
            for (const report of reports) {
                ...
                if (!metadata) {
                    ...
                    const newMetadata = await this.openAiService.getFileMetadata(
                        `## ${report.filename}\n\n${report.content}`,
                        facts
                    );
            ...
            fs.writeFileSync(this.metadataFilePath, JSON.stringify(metadataFromFile), {
                encoding: "utf-8",
            });
